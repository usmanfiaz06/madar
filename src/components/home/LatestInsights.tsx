...
const articles = [
  ...
  },
  {
    ...
    excerptEn: "Saudi Arabia is undergoing deliberate, centrally articulated transformation. When transformation is intentional, design becomes a tool of direction, not correction.",
    excerptAr: "تخوض المملكة العربية السعودية تحولاً متعمداً ومُحكم الصياغة. عندما يكون التحول مقصوداً، يصبح التصميم أداة توجيه لا تصحيح.",
    dateEn: "February 2026",
    dateAr: "فبراير ٢٠٢٦",
    categoryEn: "Design",
    categoryAr: "التصميم",
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          ...
          <Button href={`/${locale}/insights`} variant="ghost" className="shrink-0">
            {t("insightsCta")}
          </Button>
        </div>
